...
config_list = [
    {
        ...
        "model": "Mixtral 8x7b",  # the name of your running model
...
manager_prompt = \
    (
        ...
        " - Coordinating Agents: Ensure that different agents within the system work together efficiently to analyze the PDF. Each agent may have specialized tasks such as text extraction, summarization, keyword identification, and sentiment analysis."
        " - Monitoring Performance: Continuously monitor the performance of each agent to ensure accuracy and efficiency. Adjust workflows and reassign tasks as necessary to optimize results."
        " - Quality Control: Validate the output generated by the agents, ensuring the analysis is accurate, relevant, and comprehensive. Correct any errors or inconsistencies."
        " - User Communication: Provide clear and concise summaries, insights, and findings to users based on the analysis. Address user queries and feedback promptly."
        " - Maintaining System Integrity: Ensure the system operates smoothly and securely. Address any technical issues that arise and implement updates or improvements as needed."
